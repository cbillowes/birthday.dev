      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent border-l-red-400 border-l-4"
          />
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
                ...
                <div className="w-full">
                  <label
                    ...
                    className="block text-sm font-medium text-white/70 mb-1"
                  >
                    Email address <i>(for confirmation)</i>
                  </label>
                  <input
